      ...
      <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <div class="panel ornate">
          ...
          ${(state.activity.length? state.activity.slice(0,8) : [
            ...
            {text:'Dr. Ratih Wulandari signed in',date:new Date(Date.now()-3600000).toISOString()},
      ...
      <div class="certWrap">
        <div class="cert">
          ...
          <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:24px">
            <div>
              <div class="sig">Dr. Ratih Wulandari</div>
              <div style="font-size:11px;color:var(--cream-dim)">Programme Director</div>
            </div>
            <div style="text-align:right">
              <div class="sig">Dr. Joko Slamet</div>
              <div style="font-size:11px;color:var(--cream-dim)">Creator &amp; Developer</div>
            </div>
          </div>
